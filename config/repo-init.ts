...
if (!fs.existsSync('messages.json')) fs.writeFileSync('messages.json', '[]', 'utf8');
if (!fs.existsSync('webhooks.json')) fs.writeFileSync('webhooks.json', '[]', 'utf8');
if (!fs.existsSync('userAuths.json')) fs.writeFileSync('userAuths.json', '{}', 'utf8');

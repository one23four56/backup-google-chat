...
call npx esbuild pages/media/ts/script.ts --bundle --outfile=pages/media/script.js --format=esm --sourcemap
...
start npx esbuild pages/media/ts/script.ts --bundle --outfile=pages/media/script.js --format=esm --sourcemap --watch

...
function command(command: string, args: string[], _message: Message, _room: Room): string {
    if (command === "getgrade") {
        const parsedArgs = BotUtilities.generateArgMap(args, data.commands[0].args)
        ...
        const parsedArgs = BotUtilities.generateArgMap(args, data.commands[1].args)
        ...
        const parsedArgs = BotUtilities.generateArgMap(args, data.commands[2].args)

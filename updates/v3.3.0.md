...
- Style changes to rooms
  ...
  - The online users list has been moved onto a new sidebar to the right

  - The online users list now displays offline and invited users

- Style changes to the homepage

  - The chats list has been moved onto a new sidebar to the right

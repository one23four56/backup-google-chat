...
- **Details:**
  ...
  - Large internal changes to webhooks in order for them to work with rooms
    ...
    - Webhook messages are now handled the exact same as normal messages, so most webhook-exclusive bugs will finally be gone.
...
- **Details:**
  ...
  - Bot changes:
    ...
    - Archive Bot: Updated image to match with the archive icon

    - Random Bot: Updated image

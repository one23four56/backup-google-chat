...
- **Details:**
  ...
  - Completely overhauled the entire client-side channel system
    ...
    - Added a top bar to switch between different views (chat, details, options, etc) in a room
  ...
  - Bot changes:
    ...
    - Polly:
      ...
      - There are now dots after every option indicating the number of votes it has
        ...
        - Red dots (🔴) indicate someone else's vote, while green dots (🟢) indicate your vote

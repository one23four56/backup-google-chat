...
- Attempting to send an image with a size greater than 1 megabyte will result in the server abruptly closing your connection, causing a client-side crash
...
<img src="/public/v3.0.0.png" height="10%" style="border-radius:15px;margin-right:1%"><img src="/public/favicon.png" height="10%"><br><br>
Backup Google Chat Overhaul Update Patch 0 (Version 3.0.0)

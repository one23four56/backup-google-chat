...
- **Details:**
  ...
  - Bot changes:
    ...
    - Polly:
      ...
      - Increased security against crash-causing malformed requests

      - Updated the way votes are sent and received
...
## TODO fix polly i am going upstairs rn and dont want to

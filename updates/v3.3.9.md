...
<img src="/public/v3.4.0.svg" height="30%" alt="v3.4.0" style="margin-inline:auto;display:block;border-radius:15px">
...
- Switched the site emoji picker from [Picmo](https://www.npmjs.com/package/picmo) (which is now deprecated and no longer works on some browsers) to [EmojiMart](https://www.npmjs.com/package/emoji-mart)
  ...
  - <img src="/public/images/3.4.0-10.png" alt="New emoji picker" width="10%"><img src="/public/images/3.4.0-11.png" alt="New emoji picker" width="10%">
...
- Added a credits menu, found in Settings > Account
  ...
  - <img src="/public/images/3.4.0/1.png" alt="Credits Menu" width="10%">

  - Backup Google Chat is now Linnea Logan® compliant
